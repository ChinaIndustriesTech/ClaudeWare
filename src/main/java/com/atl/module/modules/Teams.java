...
public class Teams extends Module {
    ...
    public static boolean isTeammate(EntityPlayer target) {
        ...
        // 1. Armor Based Check (Slot 2 = Chestplate)
    ...
    /**
     * Logic specifically for Hypixel/Name-color based teaming
     */
    private static boolean isSameColor(EntityPlayer p1, EntityPlayer p2) {
        // Ensure both players have formatted names (contain the section symbol)
        ...
        if (name1.contains("§") && name2.contains("§")) {
            try {
                // Find the index of the section symbol and check the char immediately after it
                ...
                // Ignore 'r' (Reset) which isn't a team color
