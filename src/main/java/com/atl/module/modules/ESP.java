...
public class ESP extends Module {
    ...
    private static final long BED_RESCAN_INTERVAL = 5000;
    ...
    public ESP() {
        ...
        addSettings(showPlayers, showBeds, playerR, playerG, playerB, bedR, bedG, bedB);
    }
    ...
    public List<String> getSettings() {
        return Arrays.asList(
                ...
                "playerR (0-1)", "playerG (0-1)", "playerB (0-1)",
                "bedR (0-1)", "bedG (0-1)", "bedB (0-1)"
        );
    }
    ...
    private void drawOutline(AxisAlignedBB bb, float r, float g, float b) {
        // Fixed alpha at 1.0f (100% opacity)
        float alpha = 1.0f;
