...
public class MurderDetect extends Module {
    ...
    private void setupWeapons() {
        ...
        murderWeapons.add(Items.reeds); // sugar cane
        ...
        murderWeapons.add(Items.cooked_beef); // steak
        murderWeapons.add(Item.getItemFromBlock(Blocks.nether_brick)); // nether brick block
        murderWeapons.add(Items.nether_wart); // sometimes used instead of brick item
        ...
        murderWeapons.add(Items.speckled_melon); // glistering melon
        ...
        // Items that might be Blocks
        murderWeapons.add(Item.getItemFromBlock(Blocks.sapling));
        murderWeapons.add(Item.getItemFromBlock(Blocks.double_plant)); // rose bush
