...
public class Trajectories extends Module {
    ...
    public void onRenderWorld(RenderWorldLastEvent event) {
        ...
        // Store path points to render after we know if we hit an entity
        List<Vec3> pathPoints = new ArrayList<>();
        pathPoints.add(new Vec3(posX, posY, posZ));

        /*
         * Simulation Pass
         * We calculate the entire path first to check for entity collisions
         */
        for (int i = 0; i < 100; i++) {
        ...
        // Use the final hit state to determine the color for the whole line
