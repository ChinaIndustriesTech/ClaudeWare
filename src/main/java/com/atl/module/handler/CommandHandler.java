...
public class CommandHandler {
    ...
    private void handleSave(String[] parts) {
        ...
        boolean success = com.atl.module.ExampleMod.configManager.save(parts[1]);
        if (success) {
    ...
    private void handleLoad(String[] parts) {
        ...
        boolean success = com.atl.module.ExampleMod.configManager.load(parts[1]);
        if (success) {
    ...
    private void handleConfigs() {
        String[] configs = com.atl.module.ExampleMod.configManager.listConfigs();
        if (configs.length == 0) {
